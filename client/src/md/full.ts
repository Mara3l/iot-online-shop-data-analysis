/* eslint-disable */
/* THIS FILE WAS AUTO-GENERATED USING CATALOG EXPORTER; YOU SHOULD NOT EDIT THIS FILE; GENERATE TIME: 2021-11-24T07:56:16.933Z; */
 ...
 * Attribute ID: orderitems.quantity
 */
export const Quantity: IAttribute = newAttribute("orderitems.quantity");
/**
 * Attribute Title: Id
 * Attribute ID: orders.id
 */
export const Id: IAttribute = newAttribute("orders.id");
/**
 ...
 * Attribute ID: products.cost
 */
export const Cost: IAttribute = newAttribute("products.cost");
/**
 * Attribute Title: Id
 * Attribute ID: products.id
 */
export const Id_1: IAttribute = newAttribute("products.id");
/**
 ...
 * Attribute ID: products.price
 */
export const Price: IAttribute = newAttribute("products.price");
/**
...
/**
 * Attribute Title: Age
 * Attribute ID: users.age
 */
export const Age: IAttribute = newAttribute("users.age");
/**
 ...
 */
export const Id_2: IAttribute = newAttribute("users.id");
/**
...
export const Insights = {
    /**
     * Insight Title: State of orders by date
     * Insight ID: 66c34a86-d5da-42bc-aa37-72dfb487c234
     */
    StateOfOrdersByDate: "66c34a86-d5da-42bc-aa37-72dfb487c234",
    /**
     * Insight Title: City
     * Insight ID: 8d2a518b-f233-49e6-ae65-ed49526b0bd1
     */ City_1: "8d2a518b-f233-49e6-ae65-ed49526b0bd1",
    /**
     * Insight Title: First Visualization Test
     * Insight ID: 46871446-731d-46c0-ac08-89427bd4f05e
     */ FirstVisualizationTest: "46871446-731d-46c0-ac08-89427bd4f05e",
};
export const Dashboards = {
    /**
     * Dashboard Title: Data from Eshop
     * Dashboard ID: 9597e27c-129f-4728-a399-9028d53956d4
     */
    DataFromEshop: "9597e27c-129f-4728-a399-9028d53956d4",
};
